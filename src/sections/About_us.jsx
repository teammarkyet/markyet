      ...
      <section id="about" className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2" data-aos="fade-up" data-aos-delay="100">
              Driving Growth Through <span className="text-markyetcolor">Data & Creativity</span>
            </h2>
            <p className="text-gray-600 mt-6 leading-relaxed" data-aos="fade-up" data-aos-delay="200">
          ...
          <div className="relative" data-aos="fade-left" data-aos-delay="400">
            ...
            />
            <div className="absolute -bottom-6 -left-6 bg-white shadow-lg rounded-xl px-6 py-4 animate-pulseSlow">
